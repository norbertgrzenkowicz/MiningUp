...
Buttons::Buttons(unsigned int whichButton, sf::RenderWindow& window)
{
    ...
    switch (whichButton)
    {
        ...
        case 1:   // Przycisk odnowienia gry
            ...
            set_button(sf::Color::Transparent,
                       sf::Color::White,
                       2.f,
                       sf::Vector2f(65 + tekst.getGlobalBounds().width, 50),
                       sf::Vector2f((window.getSize().x / 2) - ((65 + tekstBounds.width) / 2), window.getSize().y / 5),
                       sf::Vector2f(button.getPosition().x + 55, window.getSize().y / 5 + (button.getGlobalBounds().height - tekstBounds.height) / 4));
        ...
        case 2:   // Przycisk powrotu do menu gwnego
            ...
            set_button(sf::Color::Transparent,
                       ...
                       2.f,
                       sf::Vector2f(65 + tekst.getGlobalBounds().width, 50),
                       sf::Vector2f((window.getSize().x / 2) - ((65 + tekstBounds.width) / 2), window.getSize().y / 2.5),
                       sf::Vector2f(button.getPosition().x + 55, window.getSize().y / 2.5 + (button.getGlobalBounds().height - tekstBounds.height) / 4));
        ...
        case 3:   // Przycisk powrotu do menu gwnego
            ...
            set_button(sf::Color::Transparent,
                       sf::Color::White,
                       2.f,
                       sf::Vector2f(65 + tekstBounds.width, 50),
                       sf::Vector2f(window.getSize().x / 2 - ((65 + tekstBounds.width) / 2), window.getSize().y / 1.66),
                       sf::Vector2f(button.getPosition().x + 55, window.getSize().y / 1.66 + (button.getGlobalBounds().height - tekstBounds.height) / 4));
        ...
        case 4:   // Przycisk powrotu do menu gwnego po mierci
            ...
            set_button(sf::Color::Transparent,
                       sf::Color::White,
                       2.f,
                       sf::Vector2f(tekstBounds.width + 56, tekstBounds.height + 50),
                       sf::Vector2f(window.getSize().x / 2 - ((button.getSize().x + tekstBounds.width) / 2), window.getSize().y * 0.50f),
                       sf::Vector2f(button.getPosition().x + 55, button.getPosition().y + 25));
            break;
        ...
        case 5:   // Przycisk wyboru wyczenia gry
            ...
            set_button(sf::Color::Transparent,
                       sf::Color::White,
                       2.f,
                       sf::Vector2f(tekstBounds.width + 100, tekstBounds.height + 60),
                       sf::Vector2f(window.getSize().x / 2 - button.getGlobalBounds().width * 1.5, window.getSize().y * 0.50f),
                       sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - tekst.getGlobalBounds().width / 2,
                                    button.getGlobalBounds().top + button.getGlobalBounds().height / 2 - tekst.getGlobalBounds().height / 2 - 10));
            break;
        ...
        case 6:   // Przycisk powrotu do gry w menu wyboru zakoczenia gry
            ...
            set_button(sf::Color::Transparent,
                       ...
                       2.f,
                       sf::Vector2f(tekstBounds.width + 100, tekstBounds.height + 60),
                       sf::Vector2f(window.getSize().x / 2 + button.getGlobalBounds().width / 2, window.getSize().y * 0.50f),
                       sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - tekst.getGlobalBounds().width / 2,
                                    button.getGlobalBounds().top + button.getGlobalBounds().height / 2 - tekst.getGlobalBounds().height / 2 - 10));
            break;
        ...
        case 7:
            ...
            set_button(sf::Color::Transparent,
                       sf::Color::White,
                       2.f,
                       sf::Vector2f(window.getSize().x / 5, window.getSize().y / 2),
                       sf::Vector2f(window.getSize().x / 10, window.getSize().y / 4),
                       sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - tekst.getGlobalBounds().width / 2,
                                    button.getGlobalBounds().top + button.getGlobalBounds().height + 10));

            set_pickaxe(sf::IntRect(0, 0, 14, 14),
                        sf::Vector2f(window.getSize().x / 5 / 20, window.getSize().y / 2 / 20),
                        sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - pickaxe.getLocalBounds().width / 2 * pickaxe.getScale().x,
                                     button.getGlobalBounds().top + button.getGlobalBounds().height / 2 - pickaxe.getLocalBounds().height / 2 * pickaxe.getScale().y)) break;
        ...
        case 8:   // Przycisk redniego poziomu trudnoci
            ...
            set_button(sf::Color::Transparent,
                       ...
                       2.f,
                       sf::Vector2f(window.getSize().x / 5, window.getSize().y / 2),
                       sf::Vector2f(window.getSize().x / 10 * 4, window.getSize().y / 4),
                       sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - tekst.getGlobalBounds().width / 2,
                                    button.getGlobalBounds().top + button.getGlobalBounds().height + 10));

            set_pickaxe(sf::IntRect(14, 0, 14, 14),
                        sf::Vector2f(window.getSize().x / 5 / 20, window.getSize().y / 2 / 20),
                        sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - pickaxe.getLocalBounds().width / 2 * pickaxe.getScale().x,
                                     button.getGlobalBounds().top + button.getGlobalBounds().height / 2 - pickaxe.getLocalBounds().height / 2 * pickaxe.getScale().y)) break;
        ...
        case 9:   // Przycisk trudnego poziomu trudnoci
            ...
            set_button(sf::Color::Transparent,
                       ...
                       2.f,
                       sf::Vector2f(window.getSize().x / 5, window.getSize().y / 2),
                       sf::Vector2f(window.getSize().x / 10 * 7, window.getSize().y / 4),
                       sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - tekst.getGlobalBounds().width / 2,
                                    button.getGlobalBounds().top + button.getGlobalBounds().height + 10));

            set_pickaxe(sf::IntRect(28, 0, 14, 14),
                        sf::Vector2f(window.getSize().x / 5 / 20, window.getSize().y / 2 / 20),
                        sf::Vector2f(button.getGlobalBounds().left + button.getGlobalBounds().width / 2 - pickaxe.getLocalBounds().width / 2 * pickaxe.getScale().x,
                                     button.getGlobalBounds().top + button.getGlobalBounds().height / 2 - pickaxe.getLocalBounds().height / 2 * pickaxe.getScale().y)) break;
...
bool Buttons::isClicked(sf::Event& event, sf::RenderWindow& window)
{
    ...
    if (mousePos.x >= buttonPos.x && mousePos.x <= buttonPos.x + buttonBounds.width + tekstBounds.width && mousePos.y >= buttonPos.y
    ...
    if (mousePos.x >= buttonPos.x && mousePos.x <= buttonPos.x + buttonBounds.width && mousePos.y >= buttonPos.y && mousePos.y <= buttonPos.y + buttonBounds.height

...
void player::objectCollision(sf::RectangleShape wall)
{
    ...
    if (wallBounds.intersects(nextPos))
    {
        ...
        if (playerBounds.left < wallBounds.left && playerBounds.left + playerBounds.width < wallBounds.left + wallBounds.width
            && playerBounds.left + playerBounds.width > wallBounds.left && playerBounds.top + 10 < wallBounds.top + wallBounds.height
        ...
        // Lewa kolizja
                 ...
                 && playerBounds.left < wallBounds.left + wallBounds.width && playerBounds.top + 10 < wallBounds.top + wallBounds.height
                 && playerBounds.top + playerBounds.height > wallBounds.top + 10)
        {
            velocity.x = 0.f;

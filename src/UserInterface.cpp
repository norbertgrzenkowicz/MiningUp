    ...
    gameOver()
{
    ...
    przyciskStop = std::make_unique<Buttons>(0U, window);
    przyciskBackToGame = std::make_unique<Buttons>(1U, window);
    przyciskRenew = std::make_unique<Buttons>(2U, window);
    przyciskBackToMenu = std::make_unique<Buttons>(3U, window);
    endGameBackToMenu = std::make_unique<Buttons>(4U, window);
    yesButton = std::make_unique<Buttons>(5U, window);
    noButton = std::make_unique<Buttons>(6U, window);
    easyButton = std::make_unique<Buttons>(7U, window);
    mediumButton = std::make_unique<Buttons>(8U, window);
    hardButton = std::make_unique<Buttons>(9U, window);

    // odczyt i zapis struktury graczy
    this->loadPlayers();

    // Pomocnicza wiadomosc o poruszaniu sie miedzy menu

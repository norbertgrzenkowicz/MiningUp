...
class Myszka
{
  public:
    ...
    void
    positioning(sf::RenderWindow& window, sf::Vector2f gamerPos, sf::FloatRect gamerBounds);   // Kompletna metoda pozycjonowania myszki oraz kafli wzgledem zasiegu postaci

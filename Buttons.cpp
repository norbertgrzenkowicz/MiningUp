...
Buttons::Buttons(int whichButton, sf::RenderWindow& window)
{
	...
	// 3 - Przycisk powrotu do menu g³ównego
	// 4 - Przycisk powrotu do menu g³ównego po œmierci
	// 5 - Przycisk wyboru wy³¹czenia gry
	// 6 - Przycisk powrotu do gry w menu wyboru zakoñczenia gry
	// 7 - Przycisk ³atwego poziomu trudnoœci
	// 8 - Przycisk œredniego poziomu trudnoœci
	// 9 - Przycisk trudnego poziomu trudnoœci
	...
	else if (whichButton == 3) //Przycisk powrotu do menu g³ównego
	{
	...
	else if (whichButton == 4)	//Przycisk powrotu do menu g³ównego po œmierci
	{
		tresc = "Wyjdz do menu";
	...
	else if (whichButton == 5)	//Przycisk wyboru wy³¹czenia gry
	{
		tresc = "Tak";
	...
	else if (whichButton == 6)	//Przycisk powrotu do gry w menu wyboru zakoñczenia gry
	{
		tresc = "Nie";
	...
	else if (whichButton == 7)	//Przycisk ³atwego poziomu trudnoœci
	{
	tresc = "Latwy";
	...
	else if (whichButton == 8)	//Przycisk œredniego poziomu trudnoœci
	{
	tresc = "Sredni";
	...
	else if (whichButton == 9)	//Przycisk trudnego poziomu trudnoœci
	{
	tresc = "Trudny";
...
{
	//Dynamiczna inicjalizacja Po³o¿enia przycisku oraz jego wymiarów
	tekstBounds = &tekst->getGlobalBounds();
	...
	&& mousePos.y <= buttonPos.y + buttonBounds->height				//Myszka wêwn¹trz przycisku
	)
	{
	...
	{
		return true;												//Przy nacisnieciu LPM metoda zwróci wartoœæ true
	}
